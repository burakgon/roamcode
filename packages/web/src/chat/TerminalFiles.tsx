...
.rc-tf__head strong { color: var(--text); font: 650 16px/1 var(--font-display); }
...
.rc-tf__preview { position: absolute; inset: 0; z-index: 23; display: flex; flex-direction: column; background: var(--bg); }.rc-tf__previewhead { min-height: 62px; display: flex; align-items: center; gap: 7px; padding: calc(8px + env(safe-area-inset-top,0px)) 10px 8px; border-bottom: 1px solid var(--border-strong); }.rc-tf__previewhead > div { min-width: 0; flex: 1; display: flex; flex-direction: column; gap: 4px; }.rc-tf__previewhead strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text); font: 600 12px/1.2 var(--terminal-font); }.rc-tf__previewhead span { color: var(--text-muted); font-size: 10px; }.rc-tf__previewhead button { min-height: 44px; display: inline-flex; align-items: center; gap: 5px; padding: 0 10px; border: 0; border-radius: 9px; background: var(--surface-2); color: var(--text); font-size: 11px; }.rc-tf__previewhead button.is-share { background: var(--coral); color: var(--on-accent); }.rc-tf__previewhead button:last-child { width: 44px; padding: 0; justify-content: center; }
.rc-tf__previewbody { position: relative; flex: 1; min-height: 0; display: grid; place-items: center; overflow: auto; padding: 12px; }.rc-tf__previewbody img { max-width: 100%; max-height: 100%; object-fit: contain; }.rc-tf__previewbody iframe { width: 100%; height: 100%; border: 0; background: white; }.rc-tf__previewbody pre { width: min(920px,100%); min-height: 100%; margin: 0; color: var(--code-text); font: 12px/1.55 var(--terminal-font); white-space: pre-wrap; overflow-wrap: anywhere; }
