// Fixed sequences for keys whose bytes never depend on terminal mode. Cursor keys are mode-dependent below.
...
// [normal mode, application-cursor-key mode (DECCKM)].
...
/** Xterm/VT modifier parameter: Shift=2, Alt=3, Ctrl=5, with combinations additive. */
